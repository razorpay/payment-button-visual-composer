...
Start accepting payments on pages or blogs built on Visual Composer Website Builder. Offer credit/debit cards, UPI, wallets and more in less than five minutes. List multiple products, or allow customers to choose the amount they want to pay. Donate Now, Buy Now, Subscribe Now, Support Now button and more
== Description ==
...
Razorpay Payment Button plugin for Visual Composer on WordPress is a payment plugin that allows you to instantly add a payment checkout function on your Visual Composer built website/blog. It requires zero coding and minimal technical expertise.

With this plugin, you can place a Donate Now, Pay Now, Buy Now, or Subscribe Now button on your Visual Composer built site/blog in less than 5 minutes.

Start accepting one time and recurring payments on your website. Set up one or multiple payment plans according to your business model. Offer your customers 100+ payment modes(UPI, NEFT, Cards, Wallets, and more)  via a single WordPress & Visual Composer payment button plugin
...
What can Razorpay Payment Button Plugin for Visual Composer on WordPress do for you?
...
= Get started faster with Razorpay Payment Button Plugins for Visual Composer =

= Install Payment Button Manually: Upload =

1. Download the plugin from WordPress Plugin Directory
2. Upload the Razorpay Payment Button for Visual Composer Zip file to the plugin >> add new >> upload a plugin
3. Activate the Razorpay Payment Button for Visual Composer plugin through the ‘Plugins’ menu in WordPress;

= Install Razorpay Button Plugin from within WordPress: =

1. Visit the plugins page within your dashboard and select **Add New**
2. Search for **Razorpay Payment Button for Visual Composer**
3. Activate Razorpay Payment Button for Visual Composer from your Plugins Page
...
**Log in to your Razorpay Account**
    ...
    2. On your WordPress Admin Dashboard:
      - Razorpay Payment Buttons for Visual Composer → Settings → Add API Secret Keys and details
...
1. Collect payments faster with pre-made templates. You can add a Donate button on your Visual COmposer built site/blog pages in seconds.
2. Powerful dashboard to help you manage your payments and track real-time data and insights.
3. Collect payments via UPI, credit/debit card, net-banking, wallets and more on your Visual Composer built site with a single plugin.
...
7. Accept International Payments in a go on your Visual Composer built pages/blogs with WordPress
...
= What does the Razorpay Payment Button for Visual Composer plugin do? =
...
= How much does a Razorpay Payment Button for Visual Composer Plugin Cost? =
...
= Why am I not able to embed the payment button code snippet directly to my WordPress & Visual Composer website? =

Go the plugin way for better and faster functioning of the Razorpay Payment Button on your Visual Composer built website. Install Razorpay Payment Button for Visual Composer Plugin and connect your website to the Razorpay dashboard easily.

= What all is required for the seamless functioning of the Razorpay Payment Button for Visual Composer Plugin? =
    - Log in to your Razorpay account
...
The Razorpay Payment Button for Visual Composer plugin is released under the GPLv2 license, same as that of WordPress. See the LICENSE file for the complete LICENSE text.
