...
class RZP_Subscription_Buttons_Visual_Composer extends WP_List_Table
{
    ...
    function column_title($item) 
    {
        ...
        $actions = array(
            'view'      => sprintf('<a href="?page=%s&btn=%s&type=%s&paged=%s">View</a>','rzp_button_view_visual_composer', $item['id'],'subscription',$paged),
        );
    ...
    */  
    ...
    function get_items($status, $count)
    {
        ...
        $rzp_payment_button_loader = new RZP_VC_Payment_Button_Loader();
